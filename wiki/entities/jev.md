...
**Uncertainty:** TypeSafe has not published the model architecture, training implementation, weights, independent evaluations, or quantitative calibration evidence. Its type-safety claim constrains output shape; it does not guarantee a correct decision. See [Schema validity versus semantic truth](../../concepts/schema-validity-vs-semantic-truth/). [S1](../../sources/typesafe-system-one-jev/)
