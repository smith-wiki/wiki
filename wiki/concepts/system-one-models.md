...
The key boundary is [schema validity versus semantic truth](../schema-validity-vs-semantic-truth/): constraining possible outputs prevents malformed values, not valid-but-wrong decisions.
